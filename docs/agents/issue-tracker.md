...
- **Child ticket**: an issue linked as a GitHub sub-issue. Where sub-issues are unavailable, add it to the map's task list and put `Part of #<map>` in the child body.
